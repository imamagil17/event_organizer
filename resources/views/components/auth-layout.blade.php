@props(['title', 'section_title' => 'Event Organizer', 'section_description' => ''])
    ...
    <main class="flex items-center justify-center min-h-screen">
        <div class="space-y-6 p-6 max-w-[30rem] w-full">
            <div class="flex gap-2 justify-center items-center">
                <i class="ph ph-calendar-blank inline-block text-4xl bg-blue-700 text-white p-1 rounded-md"></i>
                <p class="font-semibold text-sm">Event Organizer Management</p>
            </div>
