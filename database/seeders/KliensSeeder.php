...
class KliensSeeder extends Seeder
{
    public function run()
    {
        DB::table('kliens')->insert([
            ['nama' => 'Budi Santoso 1', 'email' => 'budi1@example.com', 'telepon' => '081200000001', 'alamat' => 'Jl. Mawar No. 1, Jakarta', 'jenis_klien' => 'perorangan', 'created_at' => now(), 'updated_at' => now()],
            ...
            ['nama' => 'Ani Wijaya 4', 'email' => 'ani4@example.com', 'telepon' => '081200000004', 'alamat' => 'Jl. Melati No. 4, Surabaya', 'jenis_klien' => 'perorangan', 'created_at' => now(), 'updated_at' => now()],
            ...
            ['nama' => 'Dewi Lestari 7', 'email' => 'dewi7@example.com', 'telepon' => '081200000007', 'alamat' => 'Jl. Anggrek No. 7, Medan', 'jenis_klien' => 'perorangan', 'created_at' => now(), 'updated_at' => now()],
            ...
            ['nama' => 'Joko Prasetyo 10', 'email' => 'joko10@example.com', 'telepon' => '081200000010', 'alamat' => 'Jl. Kenari No. 10, Bali', 'jenis_klien' => 'perorangan', 'created_at' => now(), 'updated_at' => now()],
            ...
            ['nama' => 'Rina Saputra 13', 'email' => 'rina13@example.com', 'telepon' => '081200000013', 'alamat' => 'Jl. Anggrek No. 13, Pontianak', 'jenis_klien' => 'perorangan', 'created_at' => now(), 'updated_at' => now()],
